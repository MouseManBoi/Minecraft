...
execute unless entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{customMoveTrigger:1b}}}}] run data modify storage minecraft:custom yuji.food.store set from entity @s SelectedItem
