...
execute store result storage minecraft:custom toji.hotbar.before int 1 run scoreboard players get @s customHotBarSelectionBefore
function custom:items/toji/lock/return with storage minecraft:custom toji.hotbar
