...
execute unless entity @s[scores={customMove1Cooldown=0,customMove2Cooldown=0,customMove3Cooldown=0,customMove4Cooldown=0,customMove5Cooldown=0,customMove6Cooldown=0}] run function custom:items/toji/scores/moves
...
execute if score @s customAwakening matches 1.. run function custom:items/toji/scores/awakening