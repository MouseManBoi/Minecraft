...
execute if score @s customHealthFetch >= healthT4 customHealthFetch run function custom:items/yuji/interaction/moves/5/prepare {number:"ONE",count:"1",cmd:"296"}
execute if score @s customHealthFetch < healthT4 customHealthFetch if score @s customHealthFetch >= healthT3 customHealthFetch run function custom:items/yuji/interaction/moves/5/prepare {number:"TWO",count:"2",cmd:"297"}
execute if score @s customHealthFetch < healthT3 customHealthFetch if score @s customHealthFetch >= healthT2 customHealthFetch run function custom:items/yuji/interaction/moves/5/prepare {number:"THREE",count:"3",cmd:"298"}
execute if score @s customHealthFetch < healthT2 customHealthFetch if score @s customHealthFetch >= healthT1 customHealthFetch run function custom:items/yuji/interaction/moves/5/prepare {number:"FOUR",count:"4",cmd:"299"}
execute if score @s customHealthFetch < healthT1 customHealthFetch run function custom:items/yuji/interaction/moves/5/prepare {number:"FIVE",count:"5",cmd:"300"}