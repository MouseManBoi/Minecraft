...
execute store result storage minecraft:custom avatar.hotbar.before int 1 run scoreboard players get @s customHotBarSelectionBefore
function custom:items/avatar/lock/return with storage minecraft:custom avatar.hotbar
