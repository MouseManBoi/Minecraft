...
execute if score .page_change ui matches 0 run function cassette:ui/pages/1/buttons

## apply mask of the ui shape -> if you are still on the same page!
execute if score @s ui.page matches 1 run function cassette:ui/pages/1/mask