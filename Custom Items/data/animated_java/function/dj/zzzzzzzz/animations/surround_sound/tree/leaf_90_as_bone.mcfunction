...
execute if entity @s[tag=aj.dj.bone.display] run data modify entity @s {} merge value {transformation:[0.8314696123025455f,0f,0.5555702330196023f,0f,0f,1f,0f,2.71875f,-0.5555702330196023f,0f,0.8314696123025455f,0f,0f,0f,0f,1f],start_interpolation:0}