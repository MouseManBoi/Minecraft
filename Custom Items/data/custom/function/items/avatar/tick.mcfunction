execute if score @s customToggle matches 1 run function custom:items/avatar/active
execute if entity @s[nbt=!{Inventory:[{components:{"minecraft:custom_data":{CustomItem:1b}},Slot:8b}]}] run function custom:items/avatar/lock/item
