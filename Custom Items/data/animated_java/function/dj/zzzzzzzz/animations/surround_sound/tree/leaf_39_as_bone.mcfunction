...
execute if entity @s[tag=aj.dj.locator_origin.display] at @s on origin run tp @s ^0 ^2.415 ^0 ~-33.84 ~0
execute if entity @s[tag=aj.dj.bone.display] run data modify entity @s {} merge value {transformation:[-0.8305958991958143f,0f,-0.5568756164881854f,0f,0f,1f,0f,2.415f,0.5568756164881854f,0f,-0.8305958991958143f,0f,0f,0f,0f,1f],start_interpolation:0}