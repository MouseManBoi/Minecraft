execute if score @s customHealth matches 1..4 unless score @s customAwakenedCooldown matches 1.. run function custom:items/gojo/awakening/main

execute if score @s customToggle matches 1 run function custom:items/gojo/active
execute if entity @s[nbt=!{Inventory:[{components:{"minecraft:custom_data":{CustomItem:1b}},Slot:8b}]}] run function custom:items/gojo/lock/item
